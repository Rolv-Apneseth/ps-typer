...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.labelMainMenu.setMinimumSize(QtCore.QSize(0, 45))
        ...
        self.comboBoxSelectMode.setMinimumSize(QtCore.QSize(350, 0))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.labelMainMenu.setText(_translate("mainWindow", "Start Typing!"))
