...
class Ui_statsWindow(object):
    def setupUi(self, statsWindow):
        ...
        self.frame_2 = QtWidgets.QFrame(statsWindow)
        self.frame_2.setMinimumSize(QtCore.QSize(350, 64))
        ...
        self.buttonMainMenu = QtWidgets.QPushButton(self.frame_2)
