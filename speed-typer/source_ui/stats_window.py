...
"}")
        ...
        self.buttonResetDaily = QtWidgets.QPushButton(statsWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout.addWidget(self.buttonResetDaily)
        ...
        self.horizontalLayout.addWidget(self.buttonResetAllTime)
        ...
        spacerItem10 = QtWidgets.QSpacerItem(18, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, statsWindow):
        ...
        self.buttonResetDaily.setText(_translate("statsWindow", "Reset today\'s highscore"))
        self.buttonResetAllTime.setText(_translate("statsWindow", "Reset all-time highscore"))
        self.buttonResetAll.setText(_translate("statsWindow", "Reset all highscores"))
